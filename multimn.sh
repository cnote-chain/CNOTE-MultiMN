...
# Author: CnoteChainOfficial
# Source: https://github.com/cnote-chain/CNOTE-MultiMN
...
function cmd_bootstrap() {
	...
	#For copied bootstrap data while new node installation // Ex. : multimn install cnote --bootstrap
...
function cmd_help() {
	echo -e "Options:\
			...
			\n**NOTE 2**: Check ${CYAN}https://github.com/cnote-chain/CNOTE-MultiMN/wiki/Commands${NC} for extended info and usage examples of each command.\
			\n**NOTE 3**: Check ${CYAN}https://github.com/cnote-chain/CNOTE-MultiMN/wiki/FAQs${NC} for technical questions and troubleshooting."
}
function cmd_update() {
	curl -sL https://raw.githubusercontent.com/cnote-chain/CNOTE-MultiMN/main/multimn_install.sh 3>&3 | bash
	exit
}
